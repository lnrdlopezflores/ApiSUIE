...
class ProyectoTitulacionController extends Controller
{
    ...
    {
        // 1. Buscar el proyecto directamente por su ID
        $proyecto = ProyectoTitulacion::findOrFail($id);
        ...
        // 3. Forzar actualización y guardar
        $proyecto->fill($validated);
        $proyecto->save();

        return response()->json([
            'message' => 'Proyecto actualizado con éxito',
            'data'    => $proyecto->fresh(['alumno', 'docenteAsesor', 'revisor'])
        ], 200);
    }
